...
import 'package:final_year_project/screens/PiCharts.dart';
import 'package:final_year_project/screens/BetaTestSection/DynamicNumTesting.dart';
                ...
                ButtonTheme(
                  ...
                  child:RaisedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => DynamicNumTesting()),
                      );
                    },
                    child: Text("Test"),
                  ),
