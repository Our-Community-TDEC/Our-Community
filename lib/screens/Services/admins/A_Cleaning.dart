...
class A_Cleaning extends StatefulWidget {
  const A_Cleaning({super.key});

  @override
  State<A_Cleaning> createState() => _A_CleaningState();
}

class _A_CleaningState extends State<A_Cleaning> {
  TextEditingController nameController = TextEditingController();
  TextEditingController mobileController = TextEditingController();
  TextEditingController sloteController = TextEditingController();
  TextEditingController timeHourController = TextEditingController();
  TextEditingController timeMinuteController = TextEditingController();
  ...
  void add() async {
    ...
    if (name != "" || mobile != "") {
      firestore.collection("cleaner").doc("cleanerdetail").set({
        "name": name,
        "mobile": mobile,
        "slot": slot,
